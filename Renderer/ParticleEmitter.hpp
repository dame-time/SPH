...
class ParticleEmitter
{
	...
	public:
		...
		// Real Usage
		void InitDamBreak(int numParticles, const BoundingBox& bounds, const Math::Scalar& paddingX = 1.0, const
		Math::Scalar& paddingY = 1.0, const Math::Scalar& spacing = 1.0);
